...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _commonDirectivesSelectableTagSelectableTagDirect = __webpack_require__(24);

	var _commonDirectivesSelectableTagSelectableTagDirect2 = _interopRequireDefault(_commonDirectivesSelectableTagSelectableTagDirect);

	var _providerDirectivesAddressAddressDirect = __webpack_require__(25);

	var _providerDirectivesAddressAddressDirect2 = _interopRequireDefault(_providerDirectivesAddressAddressDirect);

	var _providerDirectivesMenuMenuDirect = __webpack_require__(26);

	var _providerDirectivesMenuMenuDirect2 = _interopRequireDefault(_providerDirectivesMenuMenuDirect);

	var _providerDirectivesReturnPolicyReturnPolicyDirect = __webpack_require__(27);

	var _providerDirectivesReturnPolicyReturnPolicyDirect2 = _interopRequireDefault(_providerDirectivesReturnPolicyReturnPolicyDirect);

	var _providerDirectivesPasswordPasswordDirect = __webpack_require__(28);

	var _providerDirectivesPasswordPasswordDirect2 = _interopRequireDefault(_providerDirectivesPasswordPasswordDirect);

	// product directive

	var _productDirectivesProviderSideBarProviderSideBarDirect = __webpack_require__(29);

	var _productDirectivesProviderSideBarProviderSideBarDirect2 = _interopRequireDefault(_productDirectivesProviderSideBarProviderSideBarDirect);

	var _productDirectivesTextFieldTextFieldDirect = __webpack_require__(30);

	var _productDirectivesTextFieldTextFieldDirect2 = _interopRequireDefault(_productDirectivesTextFieldTextFieldDirect);

	var _saleSearchDirectivesProductProductDirect = __webpack_require__(31);

	var _saleSearchDirectivesProductProductDirect2 = _interopRequireDefault(_saleSearchDirectivesProductProductDirect);

	// controller

	var _authHomeHomeCtrl = __webpack_require__(32);

	var _authHomeHomeCtrl2 = _interopRequireDefault(_authHomeHomeCtrl);

	var _providerAddProviderCtrl = __webpack_require__(33);

	var _providerAddProviderCtrl2 = _interopRequireDefault(_providerAddProviderCtrl);

	var _providerShowProviderCtrl = __webpack_require__(34);

	var _providerShowProviderCtrl2 = _interopRequireDefault(_providerShowProviderCtrl);

	var _providerShowProviderDetailCtrl = __webpack_require__(35);

	var _providerShowProviderDetailCtrl2 = _interopRequireDefault(_providerShowProviderDetailCtrl);

	var _commonAccountMyAccountCtrl = __webpack_require__(36);

	var _commonAccountMyAccountCtrl2 = _interopRequireDefault(_commonAccountMyAccountCtrl);

	var _productAddProductCtrl = __webpack_require__(37);

	var _productAddProductCtrl2 = _interopRequireDefault(_productAddProductCtrl);

	var _productDirectivesProviderSideBarContactModalCtrlJs = __webpack_require__(38);

	var _productDirectivesProviderSideBarContactModalCtrlJs2 = _interopRequireDefault(_productDirectivesProviderSideBarContactModalCtrlJs);

	var _productShowProductCtrlJs = __webpack_require__(39);

	var _productShowProductCtrlJs2 = _interopRequireDefault(_productShowProductCtrlJs);

	var _productShowProductDetailCtrlJs = __webpack_require__(40);

	var _productShowProductDetailCtrlJs2 = _interopRequireDefault(_productShowProductDetailCtrlJs);

	var _productDirectivesItineraryAddCtrlJs = __webpack_require__(41);

	var _productDirectivesItineraryAddCtrlJs2 = _interopRequireDefault(_productDirectivesItineraryAddCtrlJs);

	var _authHomeLoginCtrl = __webpack_require__(42);

	var _authHomeLoginCtrl2 = _interopRequireDefault(_authHomeLoginCtrl);

	var _saleSaleCtrl = __webpack_require__(43);

	var _saleSaleCtrl2 = _interopRequireDefault(_saleSaleCtrl);

	var _saleSearchSearchCtrl = __webpack_require__(44);

	var _saleSearchSearchCtrl2 = _interopRequireDefault(_saleSearchSearchCtrl);

	var _saleSearchDirectivesFilterFilterCtrl = __webpack_require__(45);

	var _saleSearchDirectivesFilterFilterCtrl2 = _interopRequireDefault(_saleSearchDirectivesFilterFilterCtrl);

	var _productShowItineraryCtrl = __webpack_require__(46);

	var _productShowItineraryCtrl2 = _interopRequireDefault(_productShowItineraryCtrl);

	var _saleSearchDirectivesSigninSigninCtrl = __webpack_require__(47);

	var _saleSearchDirectivesSigninSigninCtrl2 = _interopRequireDefault(_saleSearchDirectivesSigninSigninCtrl);

	var _saleCustomerShowCustomerCtrl = __webpack_require__(48);

	var _saleCustomerShowCustomerCtrl2 = _interopRequireDefault(_saleCustomerShowCustomerCtrl);

	var _productDirectivesProviderSideBarSearchAdvanceProviderSearchCtrlJs = __webpack_require__(49);

	var _productDirectivesProviderSideBarSearchAdvanceProviderSearchCtrlJs2 = _interopRequireDefault(_productDirectivesProviderSideBarSearchAdvanceProviderSearchCtrlJs);

	var _saleSearchShowProductCtrlJs = __webpack_require__(50);

	var _saleSearchShowProductCtrlJs2 = _interopRequireDefault(_saleSearchShowProductCtrlJs);

	var _saleSearchSearchMainCtrlJs = __webpack_require__(51);

	var _saleSearchSearchMainCtrlJs2 = _interopRequireDefault(_saleSearchSearchMainCtrlJs);

	var _saleSearchDirectivesReserveReserveFormCtrlJs = __webpack_require__(52);

	var _saleSearchDirectivesReserveReserveFormCtrlJs2 = _interopRequireDefault(_saleSearchDirectivesReserveReserveFormCtrlJs);

	var _saleOrderAddOrderCtrlJs = __webpack_require__(53);

	var _saleOrderAddOrderCtrlJs2 = _interopRequireDefault(_saleOrderAddOrderCtrlJs);

	var _saleOrderShowOrderCtrlJs = __webpack_require__(54);

	var _saleOrderShowOrderCtrlJs2 = _interopRequireDefault(_saleOrderShowOrderCtrlJs);

	var _saleOrderShowOrderDetailCtrlJs = __webpack_require__(55);

	var _saleOrderShowOrderDetailCtrlJs2 = _interopRequireDefault(_saleOrderShowOrderDetailCtrlJs);

	var _saleAccountAccountCtrlJs = __webpack_require__(56);

	var _saleAccountAccountCtrlJs2 = _interopRequireDefault(_saleAccountAccountCtrlJs);

	var _commonDirectivesFormFormCtrlJs = __webpack_require__(57);

	var _commonDirectivesFormFormCtrlJs2 = _interopRequireDefault(_commonDirectivesFormFormCtrlJs);

	var _saleOrderApplyRevokeCtrlJs = __webpack_require__(58);

	var _saleOrderApplyRevokeCtrlJs2 = _interopRequireDefault(_saleOrderApplyRevokeCtrlJs);

	var _commonEmployeeShowEmployeeCtrlJs = __webpack_require__(59);

	var _commonEmployeeShowEmployeeCtrlJs2 = _interopRequireDefault(_commonEmployeeShowEmployeeCtrlJs);

	// factory

	var _commonAuthFac = __webpack_require__(60);

	var _commonAuthFac2 = _interopRequireDefault(_commonAuthFac);

	var _commonFileFac = __webpack_require__(61);

	var _commonFileFac2 = _interopRequireDefault(_commonFileFac);

	var _commonProviderFac = __webpack_require__(62);

	var _commonProviderFac2 = _interopRequireDefault(_commonProviderFac);

	var _commonProductFac = __webpack_require__(63);

	var _commonProductFac2 = _interopRequireDefault(_commonProductFac);

	var _commonItineraryFac = __webpack_require__(64);

	var _commonItineraryFac2 = _interopRequireDefault(_commonItineraryFac);

	var _commonCustomerFac = __webpack_require__(65);

	var _commonCustomerFac2 = _interopRequireDefault(_commonCustomerFac);

	var _commonUserFac = __webpack_require__(66);

	var _commonUserFac2 = _interopRequireDefault(_commonUserFac);

	var _commonOrderFac = __webpack_require__(67);

	var _commonOrderFac2 = _interopRequireDefault(_commonOrderFac);

	var _testTestFac = __webpack_require__(68);

	var _testTestFac2 = _interopRequireDefault(_testTestFac);

	var _commonErrorFac = __webpack_require__(69);

	var _commonErrorFac2 = _interopRequireDefault(_commonErrorFac);

	// Testing util

	var _testAddFakeDataFac = __webpack_require__(70);

	var _testAddFakeDataFac2 = _interopRequireDefault(_testAddFakeDataFac);

	var _testTestCtrl = __webpack_require__(71);

	var _testTestCtrl2 = _interopRequireDefault(_testTestCtrl);

	var _testIntegrationAdminFlow = __webpack_require__(72);
	...
	.directive('multiChoice', _commonDirectivesMultiChoiceMultiChoiceDirect2['default']).directive('calendar', _commonDirectivesCalendarCalendarDirect2['default']).directive('textField', _commonDirectivesTextFieldTextFieldDirect2['default']).directive('counter', _commonDirectivesCounterCounterDirect2['default']).directive('template', _commonDirectivesTemplateTemplateDirect2['default']).directive('inputForm', _commonDirectivesInputFormInputFormDirect2['default']).directive('lcHeader', _commonHeaderHeaderDirect2['default']).directive('pageControl', _commonDirectivesPagePageDirect2['default']).directive('address', _providerDirectivesAddressAddressDirect2['default']).directive('providerMenu', _providerDirectivesMenuMenuDirect2['default']).directive('returnPolicy', _providerDirectivesReturnPolicyReturnPolicyDirect2['default']).directive('password', _providerDirectivesPasswordPasswordDirect2['default'])
	// product directive 初始化
	.directive('providerSideBar', _productDirectivesProviderSideBarProviderSideBarDirect2['default']).directive('productTextfield', _productDirectivesTextFieldTextFieldDirect2['default']).directive('selectableTag', _commonDirectivesSelectableTagSelectableTagDirect2['default']).directive('product', _saleSearchDirectivesProductProductDirect2['default'])

	// controller 初始化
	.controller('homeCtrl', _authHomeHomeCtrl2['default']).controller('addProviderCtrl', _providerAddProviderCtrl2['default']).controller('showProviderCtrl', _providerShowProviderCtrl2['default']).controller('addProductCtrl', _productAddProductCtrl2['default']).controller('modalCtrl', _productDirectivesProviderSideBarContactModalCtrlJs2['default']).controller('showProductCtrl', _productShowProductCtrlJs2['default']).controller('showProductDetailCtrl', _productShowProductDetailCtrlJs2['default']).controller('addItineraryCtrl', _productDirectivesItineraryAddCtrlJs2['default']).controller('loginCtrl', _authHomeLoginCtrl2['default']).controller('saleCtrl', _saleSaleCtrl2['default']).controller('searchCtrl', _saleSearchSearchCtrl2['default']).controller('filterCtrl', _saleSearchDirectivesFilterFilterCtrl2['default']).controller('showItineraryCtrl', _productShowItineraryCtrl2['default']).controller('signinCtrl', _saleSearchDirectivesSigninSigninCtrl2['default']).controller('showCustomerCtrl', _saleCustomerShowCustomerCtrl2['default']).controller('providerSearchCtrl', _productDirectivesProviderSideBarSearchAdvanceProviderSearchCtrlJs2['default']).controller('showProviderDetailCtrl', _providerShowProviderDetailCtrl2['default']).controller('myAccountCtrl', _commonAccountMyAccountCtrl2['default']).controller('showProductSaleCtrl', _saleSearchShowProductCtrlJs2['default']).controller('reserveFormCtrl', _saleSearchDirectivesReserveReserveFormCtrlJs2['default']).controller('addOrderCtrl', _saleOrderAddOrderCtrlJs2['default']).controller('showOrderCtrl', _saleOrderShowOrderCtrlJs2['default']).controller('showOrderDetailCtrl', _saleOrderShowOrderDetailCtrlJs2['default']).controller('formCtrl', _commonDirectivesFormFormCtrlJs2['default']).controller('saleAccountCtrl', _saleAccountAccountCtrlJs2['default']).controller('searchMainCtrl', _saleSearchSearchMainCtrlJs2['default']).controller('applyRevokeCtrl', _saleOrderApplyRevokeCtrlJs2['default']).controller('showEmployeeCtrl', _commonEmployeeShowEmployeeCtrlJs2['default'])
	...
	*/
	...
	exports['default'] = ["$stateProvider", "lcConfig", "$urlRouterProvider", "$locationProvider", function ($stateProvider, lcConfig, $urlRouterProvider, $locationProvider) {
	  ...
	  $stateProvider.state('sale', {
	    ...
	    url: '/show-order',
	    templateUrl: 'app/sale/order/show_order.html',
	    controller: 'showOrderCtrl',
	    authenticate: [lcConfig.userLevel.SALE]
	  }).state('sale.show-order-detail', {
	    url: '/show-order-detail/:orderId',
	    templateUrl: 'app/sale/order/show_order_detail.html',
	    ...
	    templateUrl: 'app/product/itinerary.html',
	    controller: 'showItineraryCtrl',
	    authenticate: [lcConfig.userLevel.SALE]
	  }).state('sale.show-customers', {
	    url: '/customers',
	    templateUrl: 'app/sale/customer/show.html',
	  ...
	  $stateProvider.state('home', {
	    ...
	    templateUrl: 'app/provider/add_account.html',
	    controller: 'loginCtrl',
	    authenticate: [lcConfig.userLevel.ADMIN]
	  }).state('home.add-provider', {
	    url: '/add-provider',
	    templateUrl: 'app/provider/add.html',
	    ...
	    url: '/show-providers',
	    templateUrl: 'app/provider/show.html',
...
/***/ function(module, exports) {
	...
	var multiChoiceConfig = {
	  ...
	  data: {
	    ...
	    '海岛': [{ name: '普吉岛', value: '普吉岛' }, { name: '夏威夷', value: '夏威夷' }, { name: '塞班', value: '塞班' }, { name: '沙巴', value: '沙巴' }, { name: '岘港', value: '岘港' }, { name: '马尔代夫', value: '马尔代夫' }, { name: '塞舌尔', value: '塞舌尔' }, { name: '毛里求斯', value: '毛里求斯' }, { name: '斯里兰卡', value: '斯里兰卡' }, { name: '巴厘岛', value: '巴厘岛' }, { name: '苏梅岛', value: '苏梅岛' }, { name: '大溪地', value: '大溪地' }, { name: '长滩岛', value: '长滩岛' }, { name: '斐济', value: '斐济' }, { name: '关岛', value: '关岛' }],
...
/***/ function(module, exports) {
	...
	var menuConfig = {
	  ...
	  data: {
	    ...
	    "类型": ["跟团游", "自由行", "当地玩乐"],
	    "大区": ["出境游", "国内游", "周边游", "邮轮", "农家乐", "清凉漂流", "温泉度假", "主题推荐"],
	    "出发城市": ["上海", "北京", "天津", "南京", "杭州", "苏州"],
	    "出境游": ["东南亚", "日本", "韩国", "海岛", "欧洲", "澳新", "美洲", "中东非", "香港", "澳门", "台湾"],
	    "国内游": ["海南", "云南", "湖南", "北京", "四川", "广西", "福建", "贵州", "西北", "新疆", "内蒙", "陕西", "西藏", "湖北", "重庆", "山东", "东北", "山西", "河南", "长隆", "其他"],
	    "周边游": ["古镇水乡", "名山大川", "都市名城"],
	    "农家乐": ["崇明", "金山", "青浦", "奉贤", "磐安", "山沟沟", "太湖西山东山", "阳澄湖", "黄山", "大明山", "天目湖", "金鸡湖", "长兴", "东台山", "安吉", "蛇蟠岛", "莫干山"],
	    "清凉漂流": ["余姚漂流", "宁波漂流", "徽州漂流", "桐庐漂流", "雁荡山漂流"],
	    "温泉度假": ["天目湖温泉", "二灵山温泉", "黄山温泉", "南京汤山温泉", "临安瑞口温泉", "恐龙谷温泉", "宁波温泉", "嘉兴清池温泉", "南京颐尚温泉", "天目湖御水温泉", "苏州温泉"],
	    "主题度假": ["年夜饭", "小长假", "迪士尼"],
	    "邮轮公司": ["歌诗达邮轮", "皇家加勒比邮轮", "天海邮轮", "美国公主邮轮", "MSC（地中海）邮轮", "精致邮轮", "丽星邮轮", "荷美邮轮", "银海邮轮", "冠达邮轮", "长江黄金系列邮轮", "迪士尼邮轮", "海达路德邮轮", "渤海邮轮", "世纪游轮", "大美三峡游轮", "长海游轮", "精钻会邮轮", "PAV邮轮", "大洋邮轮", "丽晶七海邮轮", "嘉年华邮轮", "G Adventures", "阿玛河轮", "阿瓦隆邮轮", "维京邮轮公司", "星梦邮轮", "GrandCircleCruiseLine", "埃及尼罗河游轮", "可鲁西莫德", "寰宇精品内河游轮", "保罗高更邮轮", "水晶邮轮", "夸克邮轮", "伯曼邮轮", "美国维多利亚系列游轮", "世邦邮轮", "诺唯真邮轮", "三沙南海梦之旅邮轮有限公司"],
	    "邮轮航线": ["日韩", "国内", "南极", "地中海", "阿拉斯加", "加勒比海", "爱琴海", "东南亚", "欧洲", "澳新", "中东非", "北美", "环球", "港澳台", "北欧", "百慕大", "夏威夷", "南美", "巴拿马运河", "北极", "大溪地", "其他", "巴哈马", "欧美", "大西洋", "非洲", "加拿大", "美国加拿大", "跨大西洋", "美洲", "南美南极", "南太平洋", "亚马逊河", "亚洲", "远东", "太平洋", "亚马逊", "河轮", "波罗的海", "日韩两国短线"],
	    "邮轮名称": ["", "海洋量子号", "海洋水手号", "海洋航行者号", "赛琳娜号", "幸运号", "大西洋号", "蓝宝石公主号", "天海世纪号", "钻石辉煌号", "MSC抒情号"]
	  }
	};
...
/***/ function(module, exports) {
	...
	exports["default"] = ["$rootScope", "$mdDialog", "authFac", "$log", "$sce", "$state", "$scope", "$uibModal", "userFac", "lcConfig", "$window", "productFac", "orderFac", "formConfig", "providerFac", "menuConfig", "SweetAlert", function ($rootScope, $mdDialog, authFac, $log, $sce, $state, $scope, $uibModal, userFac, lcConfig, $window, productFac, orderFac, formConfig, providerFac, menuConfig, SweetAlert) {
	  ...
	  $scope.updateIndex = function (product) {
	    var confirm = $mdDialog.confirm().title("该更改可能会实时更改前台结果,请再次确认.").ok("确认").cancel("取消");
	    $mdDialog.show(confirm).then(function () {
...
/***/ function(module, exports) {
	...
	exports["default"] = ["$sce", "$scope", "$state", "$log", "$mdSidenav", "$window", "multiChoiceConfig", "$uibModal", "$activityIndicator", "lcConfig", "itineraryFac", "productFac", "menuConfig", "providerFac", function ($sce, $scope, $state, $log, $mdSidenav, $window, multiChoiceConfig, $uibModal, $activityIndicator, lcConfig, itineraryFac, productFac, menuConfig, providerFac) {
	  "ngInject";
	  ...
	  // Initilze parameters
	  $scope.options = {};
	  $scope.options["邮轮"] = [{ title: "出发城市", data: $scope.tags["出发城市"] }, { title: "行程天数", data: $scope.tags["行程天数"] }, { title: "邮轮公司", data: $scope.tags["邮轮公司"] }, { title: "邮轮航线", data: $scope.tags["邮轮航线"] }, { title: "邮轮名称", data: $scope.tags["邮轮名称"] }];

	  $scope.options["出境游"] = [{ title: "出发城市", data: $scope.tags["出发城市"] }, { title: "行程天数", data: $scope.tags["行程天数"] }, { title: "类型", data: $scope.tags["类型"] }, { title: "分区", data: menuConfig.data["出境游"] }];

	  $scope.options["国内游"] = [{ title: "出发城市", data: $scope.tags["出发城市"] }, { title: "行程天数", data: $scope.tags["行程天数"] }, { title: "分区", data: menuConfig.data["国内游"] }];

	  $scope.options["周边游"] = [{ title: "出发城市", data: $scope.tags["出发城市"] }, { title: "行程天数", data: $scope.tags["行程天数"] }, { title: "分区", data: menuConfig.data["周边游"] }];
	  ...
	  $scope.search = function (queryChanged) {
	    // Construct the query based on selected tag.
	    $scope.products = [];
	    var query = {};
	    for (var key in $scope.selectedTags) {
...
$templateCache.put("app/common/directives/selectable-tag/selectable_tag.html","<div class=\"selectabe-tag\"><span class=\"unlimited\" ng-class=\"{\'selected-tag\': $index==selectedIndex}\" ng-click=\"pick($index);\" ng-repeat=\"data in items\">{{ data }}</span></div>");
