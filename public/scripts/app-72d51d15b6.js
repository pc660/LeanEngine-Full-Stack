...
/***/ function(module, exports) {
	...
	exports['default'] = ["SweetAlert", "$log", "$scope", "$state", "$window", "$sce", "$uibModal", "orderFac", "productFac", "userFac", function (SweetAlert, $log, $scope, $state, $window, $sce, $uibModal, orderFac, productFac, userFac) {
	  'ngInject';
