...
/***/ function(module, exports) {
	...
	var multiChoiceConfig = {
	  ...
	  data: {
	    ...
	    '主营目的地': [{ name: 'ouzhou', value: '欧洲' }, { name: 'meizhou', value: '美洲' }, { name: 'aouzhou', value: '澳洲' }, { name: 'dayangzhou', value: '大洋洲' }, { name: 'dongnanya', value: '东南亚' }, { name: 'youlun', value: '邮轮' }, { name: 'haidao', value: '海岛' }, { name: 'riben', value: '日韩' }, { name: 'guoneichangxian', value: '国内长线' }, { name: 'guoneizhoubian', value: '周边短线' }, { name: 'ziyouxing', value: '自由行' }, { name: 'zijiayou', value: '自驾游' }, { name: 'gangaotai', value: '港澳台' }],
...
/***/ function(module, exports) {
	...
	exports["default"] = ["SweetAlert", "$state", "userFac", "$log", "$rootScope", "$scope", "$document", "$timeout", "lcConfig", "$window", "providerFac", "fileFac", "Upload", function (SweetAlert, $state, userFac, $log, $rootScope, $scope, $document, $timeout, lcConfig, $window, providerFac, fileFac, Upload) {
	  "ngInject";
...
$templateCache.put("app/common/product/directives/providerSideBar/providerSideBar.html","<md-sidenav class=\"md-sidenav-left\" md-component-id=\"provider-side-bar\" md-is-locked-open=\"true\" md-whiteframe=\"4\"><md-toolbar class=\"md-theme-indigo search\"><h1 class=\"md-toolbar-tools\">选择供应商</h1></md-toolbar><p ng-if=\"isLoading\">正在加载请稍等...若加载过慢,请刷新.</p><div ng-if=\"providers.length > 0 && !isLoading\" angucomplete-alt=\"\" id=\"ex1\" placeholder=\"搜索供应商\" pause=\"100\" selected-object=\"selectProvider\" local-data=\"providers\" local-search=\"searchProvider\" title-field=\"nickname,companyname\" auto-match=\"true\" minlength=\"0\" input-class=\"form-control form-control-small\"></div><div><md-content layout-padding=\"\" ng-repeat=\"provider in filterProviders\"><md-button ng-click=\"pickProvider($index)\" class=\"md-primary button\">{{ provider.nickname }} ({{ provider.companyname}})</md-button></md-content></div></md-sidenav>");
