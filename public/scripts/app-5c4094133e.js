	  ...
	  $scope.setDayContent = function (date) {
	    ...
	    if (price) {
	      ...
	      if (price.adultCompanySalePrice) {
	        ...
	        return "<p class=\"cal-price\">" + "销售价: ￥" + adultCompanySalePrice + "</p>" + "<p class=\"cal-price next\">" + "同行价: ￥" + adultCompanyCompetitorPrice + "</p>";
	      }
	    }
	    return "<p></p>";
	  };
