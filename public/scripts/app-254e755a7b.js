...
/***/ function(module, exports) {
	...
	exports["default"] = ["$state", "$log", "$scope", "$document", "$timeout", "lcConfig", "$window", "providerFac", "fileFac", "Upload", function ($state, $log, $scope, $document, $timeout, lcConfig, $window, providerFac, fileFac, Upload) {
	  "ngInject";
...
$templateCache.put("app/auth/home/home.html","<nav class=\"navbar navbar-inverse\" role=\"navigation\"><div class=\"navbar-header\"><a class=\"navbar-brand\" ui-sref=\"#\">中途港产品发布系统</a></div><ul class=\"nav navbar-nav\"><li><a ui-sref=\".add-product\">发布产品</a></li><li><a ui-sref=\".show-products\">产品管理</a></li><li ng-class=\"{\'unfinished\':unfinished}\"><span class=\"dot\"></span> <a ui-sref=\".my-account\">我的账号</a></li></ul></nav><div ui-view=\"\"></div>");
