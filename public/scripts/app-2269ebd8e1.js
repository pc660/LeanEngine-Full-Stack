...
/***/ function(module, exports) {
	...
	var menuConfig = {
	  ...
	  data: {
	    ...
	    "国内游": ["海南", "云南", "湖南", "北京", "四川", "广西", "福建", "贵州", "西北", "新疆", "内蒙", "陕西", "西藏", "湖北", "重庆", "山东", "东北", "山西", "河南", "长隆"],
	    "周边游": ["古镇水乡", "名山大川", "都市名城"]
	  }
	};
