...
/***/ function(module, exports) {
	...
	exports["default"] = function ($scope, $state, $log, $stateParams, $uibModal, productFac, $sce) {
	  ...
	  $scope.openReserveForm = function (_adult, _child) {
...
/***/ function(module, exports) {
	...
	exports["default"] = ["SweetAlert", "$scope", "$log", "$window", "$uibModalInstance", "results", "adult", "child", function (SweetAlert, $scope, $log, $window, $uibModalInstance, results, adult, child) {
	  "ngInject";
