...
/***/ function(module, exports) {
	...
	*/
	...
	exports['default'] = ["$http", "$state", "lcConfig", "$window", "Upload", function ($http, $state, lcConfig, $window, Upload) {
	  'ngInject';
	  return {
	    goAddProvider: function goAddProvider() {
	      $state.go('home');
	    },
...
/***/ function(module, exports) {
	...
	exports['default'] = ["$log", "$state", "$scope", "$uibModal", "userFac", "lcConfig", "$window", "productFac", "formConfig", "providerFac", "SweetAlert", function ($log, $state, $scope, $uibModal, userFac, lcConfig, $window, productFac, formConfig, providerFac, SweetAlert) {
	  'ngInject';
...
/***/ function(module, exports) {
	...
	exports['default'] = ["$log", "SweetAlert", "$state", "$scope", "$stateParams", "providerFac", "$mdSidenav", "$window", "dispatcherConfig", "$uibModal", "lcConfig", "itineraryFac", "productFac", "userFac", "menuConfig", function ($log, SweetAlert, $state, $scope, $stateParams, providerFac, $mdSidenav, $window, dispatcherConfig, $uibModal, lcConfig, itineraryFac, productFac, userFac, menuConfig) {
	  'ngInject';
...
/***/ function(module, exports) {
	...
	exports["default"] = ["lcConfig", "$location", "$scope", "$window", "$log", "commonSer", "helloSer", "authFac", function (lcConfig, $location, $scope, $window, $log, commonSer, helloSer, authFac) {
	  "ngInject";
...
$templateCache.put("app/auth/home/home.html","<nav class=\"navbar navbar-inverse\" role=\"navigation\"><div class=\"navbar-header\"><a class=\"navbar-brand\" ui-sref=\"#\">中途港产品发布系统</a></div><ul class=\"nav navbar-nav\"><li><a ui-sref=\".add-product\">发布产品</a></li><li ng-if=\"admin\"><a ui-sref=\".show-products\">产品管理</a></li><li ng-if=\"admin\"><a ui-sref=\".show-providers\">供应商管理</a></li><li ng-class=\"{\'unfinished\':unfinished}\"><span class=\"dot\"></span> <a ui-sref=\".my-account\">我的账号</a></li></ul></nav><div ui-view=\"\"></div>");
